...
void MainWindow::showEvent(QShowEvent *)
{
    ...
    QSound *music =new QSound(":/audioclip-1466331367.wav");
    music->play();
    /*//set background   nothing!!!!!
    QPixmap bkgnd(":/image/angry_birds___poached_eggs_theme_i_background_by_angrybirdsstuff-d6qa909.png");
...
void MainWindow::initial(){
    ...
    yellow_bird *birdie_yellow = new yellow_bird(8.0f,2.50f,0.70f,&timer,QPixmap(":/image/1321329378-3367254444.png").scaled(height()/9.0,height()/9.0),world,scene);
    itemList.push_back(birdie_yellow);
    birdList.push_back(birdie_yellow);

    Black_bird *birdie_black = new Black_bird(6.0f,2.50f,0.85f,&timer,QPixmap(":/image/pajarito5.png").scaled(height()/9.0,height()/9.0),world,scene);
    itemList.push_back(birdie_black);
    birdList.push_back(birdie_black);

    Blue_bird *birdie_blue = new Blue_bird(4.0f,2.50f,0.90f,&timer,QPixmap(":/image/pajarito2.png").scaled(height()/9.0,height()/9.0),world,scene);
